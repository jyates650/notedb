...
from tests import temp_dir, test_files_dir
...
class TestTapeWriter:
    ...
    def test_write_dataframe_to_xls(self):
        ...
        output_xls = os.path.join(temp_dir, 'output1.xlsx')
    ...
    def test_write_xls_no_template(self):
        tape_writer = TapeWriter()
        output_xls = os.path.join(temp_dir, 'output2.xlsx')
    ...
    def test_write_xls_with_template(self):
        tape_writer = TapeWriter()
        output_xls = os.path.join(temp_dir, 'output3.xlsx')
